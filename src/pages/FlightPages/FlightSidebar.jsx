           ...
           >
             ...
             <ul style={{ listStyle: "none", padding: "0",marginTop:"30px",marginLeft:"1px" }}>
               <li style={{ margin: "15px 0" ,marginTop:"40px"}}>
                 ...
                 <Link  to={'/flight'} style={{ color: "black", textDecoration: "none" ,fontWeight:"bolder",fontSize:"14px", letterSpacing: "2px"}}>
            ...
            <li style={{ margin: "15px 0" ,marginTop:"40px"}}>
              ...
              <Link  to={'/flight/addflights'} style={{ color: "black", textDecoration: "none" ,fontWeight:"bolder",fontSize:"14px", letterSpacing: "2px"}}>
              <i class="fa-solid fa-plane-departure"></i><span className='ms-2'>Flight Add </span>
              </Link>
            </li>
            <li style={{ margin: "15px 0" ,marginTop:"40px"}}>
              
              <Link  to={'/flight/flightviewbyFlightDash'} style={{ color: "black", textDecoration: "none" ,fontWeight:"bolder",fontSize:"14px", letterSpacing: "2px"}}>
              <i class="fa-solid fa-plane-departure"></i><span className='ms-2'>Flight View</span>
              </Link>
            </li>
            <li style={{ margin: "15px 0",marginTop:"40px" }}>
              
              <Link  to={'/flight/flightbookingview'} style={{ color: "black", textDecoration: "none" ,fontWeight:"bolder",fontSize:"14px", letterSpacing: "2px"}}>
              <i class="fa-solid fa-cart-shopping"></i> <span className='ms-2'>Booking Flights</span>
              </Link>
            </li>
            <li style={{ margin: "15px 0",marginTop:"40px" }}>
              
              <Link  to={'/flight/revenue'} style={{ color: "black", textDecoration: "none" ,fontWeight:"bolder",fontSize:"14px", letterSpacing: "2px"}}>
